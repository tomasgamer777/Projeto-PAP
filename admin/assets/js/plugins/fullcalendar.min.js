...
$(document).ready(function() {
    $('#fullCalendar').fullCalendar({
        ...
        // ...
        events: '/api/eventos', // Endpoint para carregar eventos (se aplicável)
        selectable: true,
        select: function(start, end) {
            ...
            // Envio do evento para o backend (exemplo com jQuery AJAX)
            $.ajax({
                url: '/api/salvar_evento.php',
                type: 'POST',
                data: {
                    title: 'Novo Evento',
                    start: start.format(), // formata a data para o formato desejado
                    end: end.format()
