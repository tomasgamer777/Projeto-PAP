                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="input-group form-control-lg">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInput11" name="sobrenome" required>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <div class="choice" data-toggle="wizard-radio">
                                    <input type="radio" name="tipo" value="4" id="admin">
                                    <div class="icon">
                            ...
                            <div class="col-sm-4">
                                <div class="choice" data-toggle="wizard-radio">
                                    <input type="radio" name="tipo" value="2" id="musico">
                                    <div class="icon">
                            ...
                            <div class="col-sm-4">
                                <div class="choice" data-toggle="wizard-radio">
                                    <input type="radio" name="tipo" value="3" id="socio">
                                    <div class="icon">
                            ...
                            <div class="col-sm-4">
                                <div class="choice" data-toggle="wizard-radio">
                                    <input type="radio" name="tipo" value="1" id="aluno">
                                    <div class="icon">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-sm-7">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control datepicker" id="data_nascimento" name="data_nasc">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="telefone" name="telef" maxlength="9" inputmode="numeric" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <div class="form-group">
